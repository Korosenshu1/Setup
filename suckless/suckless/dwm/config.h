...
static const char *fonts[]          = { "JetBrains Mono Nerd Font:size=12:antialias=true:autohint=true", "JoyPixels:pixelsize=14:antialias=true:autohint=true" };
...
static const Key keys[] = {
	...
	// Multimedia buttons for volume & microphone
